...
컴퓨터 과학의 기초 원리를 탐구하는 포스트들. 알고리즘, 논문, 자료구조 등 근본적인 "왜"를 이해하려는 탐구를 포괄한다.
...
- [프론트엔드 딥다이브](./frontend-deep-dive.md) - CS 기초 위에 쌓이는 프론트엔드 깊은 탐구
- [소프트웨어 장인정신](./software-craftsmanship.md) - 기초 원리에 대한 관심
